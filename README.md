...
* To run the app: See [Run Application](#run-application) for more information.

### Build Application

* Build local Docker image (`browsertrix-harvester:latest`): `make docker-build`
* Build dev Docker image (ECR): `make dist-dev`

### Run Application

- To run the app: `pipenv run harvester`
